...
namespace CalenderData
{
    public static class Calender
    {
       ...
       public static void GetCalendarDataPerCityAndYear(int date, int month, int Year, String City, String UrlToken, TimeZoneValues timeZone)
        {
            ...
            int day = 0;
            String fileName = String.Format("Calendar-{0}-{1}.html", month, Year);
